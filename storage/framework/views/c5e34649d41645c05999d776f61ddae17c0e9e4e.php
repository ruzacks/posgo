                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        ...
                                        <table data-v-f2a183a6="" class="summary-table">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($user->purchaseInvoiceNumberFormat($purchase->invoice_id)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Billing Date')); ?>:</td>
                                                <td><?php echo e($user->dateFormat($purchase->created_at)); ?></td>
                                            </tr>
                                            <tr>
...
<?php /**PATH D:\xampp8\htdocs\posgo\resources\views/purchases/templates/template1.blade.php ENDPATH**/ ?>