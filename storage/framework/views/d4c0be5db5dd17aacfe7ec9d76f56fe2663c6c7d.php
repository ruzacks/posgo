...
<head>
    ...
    <title><?php echo e((App\Models\Utility::getValByName('title_text'))?App\Models\Utility::getValByName('title_text') : config('app.name', 'POSGo')); ?></title>
...
<body class="<?php echo e($color); ?>">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5">
                    <h1 class="text-white mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.2s">
                        <?php echo e(__('POSGo SaaS')); ?>

                    </h1>
                    <h2 class="text-white mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.4s">
                        <?php echo e(__('Purchase and Sales Management Tool')); ?><br />
                    </h2>
                    ...
                    <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-light me-2"><i class="far fa-eye me-2"></i>Live
                            Demo</a>
                        <a href="https://codecanyon.net/item/posgo-saas-purchase-and-sales-management-tool/26199980" class="btn btn-outline-light" target="_blank"><i
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container ">
            ...
            <img src="<?php echo e(asset('landing/posgo-saas-pic-1.png')); ?>" alt=""
                class="img-fluid img-dashboard wow animate__fadeInUp" style='border-radius: 15px;' data-wow-delay="0.2s"  />
        </div>
    </section>
    <!-- [ client ] End -->
    <!-- [ dashboard ] start -->
            ...
            <div class="row align-items-center justify-content-end mb-5">
                <div class="col-sm-4">
                    ...
                    <h2 class="mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.4s">
                        Purchase and Sales <br />Management Tool
                    </h2>
                    <p class="mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.6s">
                        Use these awesome forms to login or create new account in your
                        project for free.
    ...
    <section id="feature" class="feature">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-9 title">
                    <h2>
                        <span class="d-block mb-3">Features</span> All in one place POSGo SaaS
                        system
                    </h2>
                    <p class="m-0">
                        Use these awesome forms to login or create new account in your
    ...
    <section id="price" class="price-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-9 title">
                    <h2>
                        <span class="d-block mb-3">Price</span> All in one place POSGo SaaS
                        system
                    </h2>
                    <p class="m-0">
                        Use these awesome forms to login or create new account in your
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-6 col-sm-12 text-end">
                    ...
                    <p class="text-body"> <?php echo e(__('Copyright')); ?> <?php echo e((Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :config('app.name', 'POSGo SaaS')); ?> | Design By POSGo  </p>
                </div>
            </div>
        </div>
    </section>
...
<?php /**PATH D:\xampp8\htdocs\posgo\resources\views/layouts/landing.blade.php ENDPATH**/ ?>