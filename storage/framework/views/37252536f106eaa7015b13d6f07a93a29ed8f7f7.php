            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-37eeda86="" class="d"  style="width:750px;margin-left: 30px;margin-right: auto;">
                            <div data-v-37eeda86="" class="d-inner">
                                ...
                                <div data-v-37eeda86="" class="row">
                                    <div data-v-37eeda86="" class="col-66">
                                        <strong class="tu mb5" style="color: <?php echo e(($color == '#ffffff') ? 'black': $color); ?>;"><?php echo e(__('Bill To')); ?>:</strong>
                                    ...
                                    <div data-v-37eeda86="" class="col-33"><strong data-v-37eeda86="" class="tu mb5" style="color: <?php echo e(($color == '#ffffff') ? 'black': $color); ?>;"><?php echo e(__('INVOICE')); ?></strong>
                                ...
                                <div data-v-37eeda86="" class="break-60"></div>
                                <div data-v-37eeda86="" class="d-table">
                                    <div data-v-37eeda86="" class="d-table">
                                        <div data-v-37eeda86="" class="tu d-table-tr" style="color: <?php echo e(($color == '#ffffff') ? 'black': $color); ?>; border-bottom: 1px solid <?php echo e(($color == '#ffffff') ? 'black': $color); ?>; border-top: 1px solid <?php echo e(($color == '#ffffff') ? 'black': $color); ?>;">
                                        ...
                                        <div data-v-37eeda86="" class="d-table-body">
                                            <?php if(isset($purchase->items) && count($purchase->items) > 0): ?>
                                                ...
                                                <div class="d-table-tr" style="border-top: 1px solid <?php echo e(($color == '#ffffff') ? 'black': $color); ?>; border-bottom: 1px solid <?php echo e(($color == '#ffffff') ? 'black': $color); ?>;">
...
<?php /**PATH D:\xampp8\htdocs\posgo\resources\views/purchases/templates/template2.blade.php ENDPATH**/ ?>