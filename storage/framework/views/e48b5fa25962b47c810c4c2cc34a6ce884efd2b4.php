                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>;">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    <div data-v-f2a183a6="" class="d-header-50">
                                        ...
                                        <p><?php echo DNS2D::getBarcodeHTML(route('sale.link.copy',\Illuminate\Support\Facades\Crypt::encrypt($sale->id)),'QRCODE',2,2); ?></p>
                                    </div>
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        ...
                                        <table data-v-f2a183a6="" class="summary-table">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($user->sellInvoiceNumberFormat($sale->invoice_id)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Billing Date')); ?>:</td>
                                                <td><?php echo e($user->dateFormat($sale->created_at)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Billing Time')); ?>:</td>
                                                <td><?php echo e($user->timeFormat($sale->created_at)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Status')); ?>:</td>
                                                <td><?php echo e(($sale->status == 1) ? __('Partially Paid') : (($sale->status == 2) ? __('Paid') : __('Unpaid'))); ?></td>
                                            </tr>
                                        ...
                                        <div data-v-f2a183a6="" class="d-table">
                                            ...
                                            <div class="d-table-body">
                                                <?php if(isset($sale->items) && count($sale->items) > 0): ?>
                                                    <?php $__currentLoopData = $sale->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e(($color == '#ffffff') ? 'black' : $color); ?>; border-bottom: 1px solid <?php echo e(($color == '#ffffff') ? 'black' : $color); ?>;">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e($sale->subtotal); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php if(!isset($preview)): ?>
    <?php echo $__env->make('sales.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
<?php endif; ?>
</body>
</html>
<?php /**PATH D:\xampp8\htdocs\posgo\resources\views/sales/templates/template1.blade.php ENDPATH**/ ?>