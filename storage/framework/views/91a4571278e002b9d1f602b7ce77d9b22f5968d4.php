...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::number('min_stock', null, ['class' => 'form-control', 'placeholder' => __('Enter new Minimum Stock'), 'step' => '1', 'id' => 'min_stock', 'readonly' => 'readonly'])); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::number('max_stock', null, ['class' => 'form-control', 'placeholder' => __('Enter new Maximum Stock'), 'step' => '1', 'id' => 'max_stock', 'readonly' => 'readonly'])); ?>
    ...
    <div class="row">
        <div class="form-group col-md-4">
            ...
            <?php echo e(Form::number('purchase_price', null, ['class' => 'form-control', 'placeholder' => __('Enter new Purchase Price'), 'step' => '1000'])); ?>

        </div>
        <div class="form-group col-md-4">
            <?php echo e(Form::label('sale_price', __('Selling price') . ' (' . Auth::user()->currencySymbol() . ')', ['class' => 'col-form-label'])); ?>

            <?php echo e(Form::number('sale_price', null, ['class' => 'form-control', 'placeholder' => __('Enter new Selling Price'), 'step' => '1000'])); ?>
