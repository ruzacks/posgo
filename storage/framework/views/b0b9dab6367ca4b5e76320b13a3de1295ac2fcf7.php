...
<!DOCTYPE html>
<html dir="<?php echo e(Utility::getValByName('SITE_RTL') == 'on' ? 'rtl' : ''); ?>">
    ...
    <div class="auth-wrapper auth-v3">
        ...
        <div class="auth-content">
            <nav class="navbar navbar-expand-md navbar-light default">
                ...
                alt="<?php echo e(config('app.name', 'Posgo')); ?>" class="logo logo-lg" width="100px">
                    </a>
            ...
            <div class="auth-footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-6">
                            <?php echo e(__('Copyright')); ?>  <?php echo e(\App\Models\Utility::getValByName('footer_text')? \App\Models\Utility::getValByName('footer_text'): config('app.name', 'POSGo')); ?>
...
<?php /**PATH D:\xampp8\htdocs\posgo\resources\views/layouts/master.blade.php ENDPATH**/ ?>