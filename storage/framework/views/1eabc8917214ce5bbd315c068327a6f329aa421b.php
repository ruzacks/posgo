            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-check">
                        <?php echo e(Form::checkbox('is_consigment', 1, null, ['class' => 'form-check-input', 'id' => 'is_consigment'])); ?>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-check">
                        <?php echo e(Form::checkbox('is_stock', 1, null, ['class' => 'form-check-input', 'id' => 'is_stock'])); ?>
