            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-f2a183a6="" class="d" id="boxes" style="width:750px;margin-left: 30px;margin-right: auto;">
                                ...
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    <div data-v-f2a183a6="" class="d-header-50">
                                        <div data-v-f2a183a6="" class="d-header-brand">
                                            <img src="<?php echo e($img); ?>" style="max-width: 100px"/>
                                        </div>
                                        ...
                                        <p data-v-f2a183a6="">
                                            ...
                                            <?php if($settings['company_zipcode']): ?> <br><?php echo e($settings['company_zipcode']); ?><?php endif; ?>
                                                <br>  <?php if(!empty($settings['tax_type']) && !empty($settings['vat_number'])): ?><?php echo e($settings['tax_type'].' '. __('Number')); ?> : <?php echo e($settings['vat_number']); ?> <br><?php endif; ?>

                                        </p>
                                        <p><?php echo DNS2D::getBarcodeHTML(route('get.quotation.invoice',\Illuminate\Support\Facades\Crypt::encrypt($quotation->invoice_id)),'QRCODE',2,2); ?></p>
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        ...
                                        <table data-v-f2a183a6="" class="summary-table">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($user->quotationInvoiceNumberFormat($quotation->invoice_id)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Billing Date')); ?>:</td>
                                                <td><?php echo e($user->dateFormat($quotation->created_at)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Billing Time')); ?>:</td>
                                                <td><?php echo e($user->timeFormat($quotation->created_at)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Status')); ?>:</td>
                                                <td><?php echo e(($quotation->status == 1) ? __('Close') : __('Open')); ?></td>
                                            </tr>
                            ...
                            <div data-v-f2a183a6="" class="d-body">
                                <div data-v-f2a183a6="" class="d-bill-to"><strong data-v-f2a183a6=""><?php echo e(__('Bill To')); ?>:</strong>
                                    <?php if(isset($customerdetails) && !empty($customerdetails)): ?>
                                        <p>
                                            <?php $__currentLoopData = $customerdetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            ...
                                            <div class="d-table-body">
                                                <?php if(isset($quotation->items) && count($quotation->items) > 0): ?>
                                                    <?php $__currentLoopData = $quotation->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e(($color == '#ffffff') ? 'black': $color); ?>; border-bottom: 1px solid <?php echo e(($color == '#ffffff') ? 'black': $color); ?>;">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e($quotation->subtotal); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php if(!isset($preview)): ?>
    <?php echo $__env->make('quotations.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
<?php endif; ?>
</body>
</html>
<?php /**PATH D:\xampp8\htdocs\posgo\resources\views/quotations/templates/template1.blade.php ENDPATH**/ ?>