<?php $__env->startSection('page-title', __('Purchase Daily/Monthly Report')); ?>

<?php $__env->startSection('title'); ?>
    <div class="d-inline-block">
        <h4 class="title"><?php echo e(__('Purchase Daily/Monthly Report')); ?></h4>
    </div>
...
<li class="breadcrumb-item"><?php echo e(__('Purchase Daily')); ?></li>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('action-btn'); ?>
    <a class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="collapse"
    data-bs-target=".multi-collapse-daily-purchase" title="<?php echo e(__('Filter')); ?>"><i
        ...
        <ul class="nav nav-pills my-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                    href="<?php echo e(route('purchased.monthly.analysis')); ?>"
                    onclick="window.location.href = '<?php echo e(route('purchased.monthly.analysis')); ?>'" role="tab"
                    ...
                    <div class="row input-daterange analysis-datepicker align-items-center">
                        <div class="form-group col-md-3 mb-0">
                            ...
                            <div class="input-group">
                                <?php echo e(Form::text('start-date', $start_date, ['class' => 'form-control','placeholder' => __('Select Start date'),'id' => 'start-date'])); ?>
                        ...
                        <div class="form-group col-md-3 mb-0">
                            ...
                            <div class="input-group">
                                ...
                                <?php echo e(Form::text('end-date', $end_date, ['class' => 'form-control','placeholder' => __('Select End date'),'id' => 'end-date'])); ?>
    ...
    <?php $__env->startPush('scripts'); ?>
        ...
        <script type="text/javascript">
            ...
            function ajax_purchase_daily_chart_filter() {
                ...
                $.ajax({
                    url: '<?php echo e(route('purchased.daily.chart.filter')); ?>',
                    dataType: 'json',
                    data: data,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp8\htdocs\posgo\resources\views/reports/purchased-daily.blade.php ENDPATH**/ ?>