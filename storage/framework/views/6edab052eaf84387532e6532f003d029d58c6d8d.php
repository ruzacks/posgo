...
<head>
    <title>
        ...
        <?php echo e(\App\Models\Utility::settings()['company_name'] != '' ? \App\Models\Utility::settings()['company_name'] : config('app.name', 'POSGo Saas-Purchase')); ?>
                ...
                <?php $lastsegment = request()->segment(count(request()->segments())) ?>
                    ...
                    <div class="col-12">
                        <div class="mt-2 pos-top-bar bg-color d-flex justify-content-between">
                            <span class="text-white"><?php echo e(__('Purchases')); ?></span>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="input-group search_vendor_merge_input">
                                                ...
                                                <?php echo e(Form::text('searchvendors', null, ['class' => 'form-control pr-4 rounded-right', 'id' => 'searchvendors', 'placeholder' => __('Search Vendor')])); ?>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between pt-3" id="btn-pur">
                                                        ...
                                                        <div class="tab-content">
                                                            <button type="button" class="btn btn-primary rounded" style="width: 100%"
                                                             ...
                                                             <a href="" id="pos_pay" data-ajax-popup="true" data-size="lg" data-align="centered" data-url="<?php echo e(route('purchases.create')); ?>"
                                                             data-title="<?php echo e(__('Purchase Products')); ?>"></a>
                                                        </div>
        ...
        $( ".cat-active" ).click();
            ...
            $("#searchvendors").autocomplete({
                ...
                source: function(request, response) {
                    $.getJSON("<?php echo e(route('search.vendors')); ?>", {
                        search: request.term
                    }, response);
                },
                search: function() {
...
<?php /**PATH D:\xampp8\htdocs\posgo\resources\views/purchases/index.blade.php ENDPATH**/ ?>