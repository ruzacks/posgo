            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-363339a0="" class="d" style="width:750px;margin-left: 30px;margin-right: auto;" id="boxes">
                            <div data-v-363339a0="" class="d-inner">
                                <div data-v-363339a0="" class="row">
                                    <div data-v-363339a0="" class="col-3"><h1 data-v-363339a0="" class="fancy-title tu mb5" style="color: <?php echo e(($color == '#ffffff') ? 'black': $color); ?>;"><?php echo e(__('INVOICE')); ?></h1>
                                        ...
                                        <p data-v-363339a0=""><?php if($settings['company_city']): ?> <?php echo e($settings['company_city']); ?>, <?php endif; ?> <?php if($settings['company_state']): ?><?php echo e($settings['company_state']); ?><?php endif; ?> <?php if($settings['company_zipcode']): ?> - <?php echo e($settings['company_zipcode']); ?><?php endif; ?></p>
                                        <p data-v-363339a0=""><?php if($settings['company_country']): ?> <?php echo e($settings['company_country']); ?><?php endif; ?></p>
                                        <p data-v-363339a0=""><?php if($settings['company_zipcode']): ?> <?php echo e($settings['company_zipcode']); ?><?php endif; ?></p>
                                    ...
                                    <div data-v-363339a0="" class="col-1">
                                        <img data-v-363339a0="" src="<?php echo e($img); ?>" style="max-width: 150px" class="d-logo">
                                    </div>
                                </div>
                                ...
                                <div data-v-363339a0="" class="row">
                                    ...
                                    <div data-v-363339a0="" class="col-33">
                                        <table data-v-363339a0="" class="summary-table">
                                            ...
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu" style="color: <?php echo e(($color == '#ffffff') ? 'black': $color); ?>;"><?php echo e(__('Number')); ?>:</td>
                                                <td data-v-37eeda86="" class="text-right"><?php echo e($user->purchaseInvoiceNumberFormat($purchase->invoice_id)); ?></td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu" style="color: <?php echo e(($color == '#ffffff') ? 'black': $color); ?>;"><?php echo e(__('Billing Date')); ?>:</td>
                                                <td data-v-37eeda86="" class="text-right"><?php echo e($user->dateFormat($purchase->created_at)); ?></td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu" style="color: <?php echo e(($color == '#ffffff') ? 'black': $color); ?>;"><?php echo e(__('Billing Time')); ?>:</td>
                                                <td data-v-37eeda86="" class="text-right"><?php echo e($user->timeFormat($purchase->created_at)); ?></td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu" style="color: <?php echo e(($color == '#ffffff') ? 'black': $color); ?>;"><?php echo e(__('Status')); ?>:</td>
                                            ...
                                            <tr class="ml-8" >
                                                <td class="">
                                                    ...
                                                    /* <p><?php echo DNS2D::getBarcodeHTML($user->purchaseInvoiceNumberFormat($purchase->invoice_id), "QRCODE",5,5); ?></p> */
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div data-v-363339a0="" class="break-60"></div>
                                <div data-v-363339a0="" class="d-table">
                                    <div data-v-e95a8a8c="" class="d-table">
                                        <div data-v-e95a8a8c="" class="tu d-table-tr" style="color: <?php echo e(($color == '#ffffff') ? 'black': $color); ?>; border-bottom: 1px solid <?php echo e(($color == '#ffffff') ? 'black': $color); ?>; border-top: 1px solid <?php echo e(($color == '#ffffff') ? 'black': $color); ?>;">
...
<?php /**PATH D:\xampp8\htdocs\posgo\resources\views/purchases/templates/template4.blade.php ENDPATH**/ ?>