                ...
                @if (Gate::check('Manage User') || Gate::check('Manage Role') || Gate::check('Manage Permission'))
                    <li class="dash-item dash-hasmenu">
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                                ...
                                class="dash-mtext">{{ __('Master') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="dash-sub-item mx-2" style="display: none">

                            @can('Manage User')
                                <li class="dash-item dash-hasmenu">
                                    <a class="dash-link sub-item" href="{{ route('users.index') }}">
                                        <span class="dash-micon"><i class="ti ti-users"></i></span>{{ __('Users') }}
                                    </a>
                                </li>
                            @endcan
                            ...
                            @can('Manage Vendor')
                                <li class="dash-item dash-hasmenu">
                                    <a class="dash-link sub-item" href="{{ route('vendors.index') }}">
                                        <span class="dash-micon"><i class="ti ti-package"></i></span>{{ __('Vendors') }}
                                    </a>
                                </li>
                            @endcan
                            ...
                            @can('Manage Product')
                                <li class="dash-item dash-hasmenu">
                                    <a class="dash-link sub-item" href="{{ route('products.index') }}">
                                        <span class="dash-micon"><i class="ti ti-box"></i></span>{{ __('Products') }}
                                    </a>
                                </li>
                            @endcan
                            ...
                            @can('Manage Talent')
                                <li class="dash-item dash-hasmenu">
                                    <a class="dash-link sub-item" href="{{ route('talents.index') }}">
                                        <span class="dash-micon"><i class="ti ti-star"></i></span>{{ __('Talents') }}
                                    </a>
                                </li>
                            @endcan
