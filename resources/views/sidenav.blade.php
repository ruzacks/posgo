            ...
            @if (Gate::check('Manage Product') || Gate::check('Manage Category') || Gate::check('Manage Brand') || Gate::check('Manage Tax') || Gate::check('Manage Unit'))
                <li class="dash-item dash-hasmenu">
                    ...
                    <ul class="dash-submenu">
                        ...
                        @can('Manage Product')
                            <li class="dash-item dash-hasmenu">
                                <a class="dash-link" href="{{ route('products.index') }}">{{ __('Products') }}</a>
                            </li>
                        @endcan

                        @can('Manage Category')
                            <li class="dash-item dash-hasmenu">
                                <a class="dash-link" href="{{ route('categories.index') }}">{{ __('Categories') }}</a>
                            </li>
                        @endcan
                        ...
                        @can('Manage Unit')
                            <li class="dash-item dash-hasmenu">
                                <a class="dash-link" href="{{ route('units.index') }}">{{ __('Unit') }}</a>
                            </li>
                        @endcan
