...
<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-6">
            ...
            {{ Form::text('code', null, ['class' => 'form-control', 'placeholder' => __('Enter new Product Code'), 'required' => '', 'autocomplete' => 'off']) }}
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('name', __('Product Name'), ['class' => 'col-form-label']) }}
            {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => __('Enter new Product Name'), 'required' => '', 'autocomplete' => 'off']) }}
        </div>
        <div class="form-group col-md-6">
            {{ Form::label('category_id', __('Category'), ['class' => 'col-form-label']) }}
            <div class="input-group">
                {{ Form::select('category_id', $categories, null, ['class' => 'form-control', 'data-toggle' => 'select', 'required' => '', 'autocomplete' => 'off']) }}
            </div>
        </div>
        ...
        <div class="form-group col-md-6">
            ...
            <div class="input-group">
                {{ Form::select('unit_id', $units, null, ['class' => 'form-control', 'data-toggle' => 'select', 'required' => '', 'autocomplete' => 'off']) }}
            </div>
        </div>
