{{ Form::model($locationPrice,['url' => 'location-price', 'id' => 'location-price-form']) }}
...
<div class="modal-footer">
    ...
    <input class="btn btn-primary" id="submit-btn" value="{{ __('Edit') }}" type="button">
</div>
{{ Form::close() }}
...
<script>
       $('#submit-btn').on('click', function() {
        ...
        $.ajax({
            url: "{{ route('location-prices.update', $locationPrice->id) }}",
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function(data) {
                if (data.success) {
                    ...
                    $.ajax({
                        url: "{{ route('location-prices.index', $locationPrice->location_type_id) }}",
                        type: 'GET',
