...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0">{{ __('Purchases') }}</h5>
    </div>
@endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Purchase list') }}</li>
@endsection
...
@can('Manage Purchases')
            ...
            <div class="col-12">
                <div class="card collapse multi-collapse">
                    <div class="card-body p-3">
                        <div class="row input-daterange analysis-datepicker align-items-center">
                            ...
                            <div class="form-group col-md-4 mb-0">
                                {{ Form::label('purchased_from', __('Purchased From'), ['class' => 'form-control-label']) }}
                                <div class="input-group">
                                    {{ Form::select('purchased_from', $vendors, null, ['class' => 'form-control', 'id' => 'purchased_from', 'data-toggle' => 'select']) }}
                                </div>
                            </div>
                            <div class="form-group col-md-4 mb-0">
                                {{ Form::label('purchased_by', __('Purchased By'), ['class' => 'form-control-label']) }}
                                <div class="input-group">
                                    {{ Form::select('purchased_by', $users, null, ['class' => 'form-control', 'id' => 'purchased_by', 'data-toggle' => 'select']) }}
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card table-card">
                    <div class="card-header card-body table-border-style">
                        {{-- <h5></h5> --}}
                        <div class="col-sm-12 table-responsive table_over">
    ...
    @push('scripts')
        ...
        <script type="text/javascript">
            ...
            $(document).on('change', '#purchased_from, #purchased_by', function(e) {
                ajax_invoice_filter();
            });
            ...
            function ajax_invoice_filter() {
                var data = {
                    ...
                    'start_date': $('input[name="start_date1"]').val(),
                    'end_date': $('input[name="due_date1"]').val(),
                    'vendor_id': $('#purchased_from').val(),
                    'user_id': $('#purchased_by').val(),
                    'vendors': 1,
                }
